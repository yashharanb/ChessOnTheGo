...
//must have '/login' as tht is the "signal" from the welcome/login screen when the user presses the login button
//error messages for logging in are generated bythe passport.js file in the config folder
